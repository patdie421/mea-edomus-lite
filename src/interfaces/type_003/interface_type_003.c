...
//NOTIFY   mea_notify_printf('S', "%s %s", start_stop_params->i003->name, stopped_successfully_str);
...
//NOTIFY   mea_notify_printf('S', "%s %s", start_stop_params->i003->name, launched_successfully_str);
